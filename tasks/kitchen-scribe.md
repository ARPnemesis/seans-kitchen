...
1. REFRESH THE README
   - Read the current week's Menu_Week_of_*.md (most recent) in E:\Seans_Royal_Kitchen\ for the dish lineup.
   - Write/overwrite E:\Seans_Royal_Kitchen\README.md covering: current week's menu, the full 8-task team roster + schedules, the Friday pipeline diagram, and the sync architecture (host PS1 → GitHub). Keep it accurate and concise.
